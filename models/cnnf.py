...
from models.base import BasicModule
import os

__all__ = ['get_cnnf', 'CNNF']

abs_dir = "/home/carry6/LS_project/Experiment/models"

pretrain_model = os.path.join(abs_dir, "", "imagenet-vgg-f.pth")


class CNNF(BasicModule):
    def __init__(self, bit, leakRelu=True, bn=True):
...
def get_cnnf(bit, pretrain=False, leakRelu=None, bn=True):
